...
Ce projet, dit frontend, est connecté à un service API backend (Dev_App_Projet_n_9_Back )que vous devez aussi lancer en local.

bill-app/
   - Dev_App_Projet_n_9_Back
   - Dev_App_Projet_n_9_Front
```
...
## Comment lancer l'application en local après avoir installer le Back end?

### Lancer le frontend :

Allez au repo :
```
$ cd Dev_App_Projet_n_9_Front
```

Installez les packages npm incluant live-server (décrits dans `package.json`) :
```
$ npm install
```
